...
struct Library_nanoFramework_Hardware_Esp32_RMT_Tx_nanoFramework_Hardware_Esp32_RMT_Tx_Transmitter
{
    ...
    NANOCLR_NATIVE_DECLARE(NativeGetLoopTxMode___STATIC__BOOLEAN__I4);
    NANOCLR_NATIVE_DECLARE(NativeGetTransmitterIdleLevel___STATIC__VOID__I4__BYREF_BOOLEAN__BYREF_BOOLEAN);
    ...
    NANOCLR_NATIVE_DECLARE(NativeSetLoopTxMode___STATIC__VOID__I4__BOOLEAN);
    NANOCLR_NATIVE_DECLARE(NativeSetSource80MHz___STATIC__VOID__I4__BOOLEAN);
    NANOCLR_NATIVE_DECLARE(NativeSetTransmitterIdleLevel___STATIC__VOID__I4__BOOLEAN__BOOLEAN);
    NANOCLR_NATIVE_DECLARE(NativeSetCarioerMode___STATIC__VOID__I4__BOOLEAN__U2__U2__BOOLEAN);
